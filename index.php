...
<body>
  <div class="container">
    <h1 class="heading">Bài tập trắc nghiệm</h1>
    <div class="panel-group">
      ...
      <div class="logout">
		<button id="btnQuestion" class="btn btn-success" style=" margin-top:20px">

		<a href="logout_main.php" style="font-size: 16px; color:#fff">đăng xuất 
...
function CheckResult(){
  ...
  $('#questions div.row').each(function(k,v){
    ...
    // đánh dấu đáp án đúng để người dùng đối chiếu
